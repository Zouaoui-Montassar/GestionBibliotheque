...
public class ModifierDate {
    public ModifierDate(Utilisateur user,Emprunt emprunt , Livre livre , String ch){
        ...
        JLabel label1 = new JLabel("Veuillez saisir combien voulez vous ajouter de jours a votre emprunt : ");
        frame.add(label1);
        ...
        button.addActionListener(e -> {
            ...
            try {
                ...
                frame.dispose();
                JOptionPane.showMessageDialog(frame, "Emprunt prolongeé avec success");}
