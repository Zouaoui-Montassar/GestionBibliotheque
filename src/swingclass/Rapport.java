...
public class Rapport {
    public Rapport(Utilisateur user) {
        ...
        bookModel.addColumn("Titre");
        bookModel.addColumn("Auteur");
        bookModel.addColumn("Genre");
        bookModel.addColumn("Nombre d'emprunts");

        userModel.addColumn("Nom");
        userModel.addColumn("Prénom");
        userModel.addColumn("Role");
        userModel.addColumn("Nombre de livre emprunté");

        List<String> rapports = Emprunt.GenererRapport();
        ...
        buttonAccueil.addActionListener(e -> {
            SwingUtilities.invokeLater(() -> new AcceuilBibliothecaire(user));
            frame.dispose();
        });
